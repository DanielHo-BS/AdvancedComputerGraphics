...
function main()
{
    ...
    var cameraRef = new THREE.PerspectiveCamera(45, (window.innerWidth-16) / (window.innerHeight-16), 5, 3000)
    cameraRef.position.set(0,-300,500)
    cameraRef.lookAt(0,0,0)
    scene.add(cameraRef);

    const cameraRefHelper = new THREE.CameraHelper(cameraRef) 
    scene.add(cameraRefHelper)
    
    console.log(cameraRef.matrix)
